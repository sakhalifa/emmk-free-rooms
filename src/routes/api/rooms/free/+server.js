 ...
 */
const params = [
	{ name: 'startHour', required: true, type: 'int', min: 0, max: 24, _parser: async (n) => Number(n), _checkFunction: async (n) => Number.isInteger(n), _parseFailMessage: "Not a valid integer!" },
	...
	{ name: 'endHour', required: true, type: 'int', min: 0, max: 24, _parser: async (n) => Number(n), _checkFunction: async (n) => Number.isInteger(n), _parseFailMessage: "Not a valid integer!"},
